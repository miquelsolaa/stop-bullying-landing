      ...
      <header className="border-b sticky top-0 z-50 bg-white">
        <div className="container flex h-16 items-center justify-between py-4">
          ...
          <nav className="hidden md:flex gap-6">
            <a href="#inici" className="text-sm font-medium hover:text-rose-500 transition-colors">
              Inici
            </a>
            <a href="#sobre-nosaltres" className="text-sm font-medium hover:text-rose-500 transition-colors">
              Sobre Nosaltres
            </a>
            <a href="#beneficis" className="text-sm font-medium hover:text-rose-500 transition-colors">
              Beneficis
            </a>
            <a href="#testimonis" className="text-sm font-medium hover:text-rose-500 transition-colors">
              Testimonis
            </a>
            <a href="#com-funciona" className="text-sm font-medium hover:text-rose-500 transition-colors">
              Com Funciona
            </a>
          </nav>
          <Link href="/contacte">
          ...
          <div className="container">
            <div className="max-w-3xl mx-auto text-center space-y-4">
              ...
              <p className="text-lg text-gray-700 mt-6">
                ...
                desenvolupar habilitats socials per afrontar el bullying i els reptes interpersonals. La nostra coach,
        ...
        <section className="py-16 md:py-24 bg-gradient-to-r from-rose-500 to-amber-500 text-white">
          <div className="container text-center space-y-8">
            ...
            <p className="text-xl max-w-2xl mx-auto">
              No esperis més per millorar les teves habilitats socials i superar el bullying. El canvi comença amb un
              primer pas.
            </p>
